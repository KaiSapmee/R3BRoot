...
void R3BQFSGenerator::SetBeamEnergy(double E)
{
    ENERGY = E;
    return;
}
...
Bool_t R3BQFSGenerator::ReadEvent(FairPrimaryGenerator* primGen)
{
    ...
    if (INVERSE)
    {
        ...
        while (!evt) // eventloop
        {
            ...
            std::pair<double, double> lora = R3BQFSGenerator::Lorentz(gA, bA, Ea, Pa.Z());
...
void R3BQFSGenerator::SetValues(double E, int A, double MOM, double exe, bool invert, bool iso)
{
    ENERGY = E;
    MOM_SIGMA = MOM;
    A_BEAM = A;
